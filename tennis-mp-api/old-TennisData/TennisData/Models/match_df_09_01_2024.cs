...
public partial class match_df_09_01_2024
{
    public string tny_id { get; set; } = null!;

    public string tny_name { get; set; } = null!;
    ...
    public double? w_commop_match_prob { get; set; }

    public bool winner { get; set; }

    public string p0_name { get; set; } = null!;

    public string p1_name { get; set; } = null!;
    ...
    public double? p0_swon { get; set; }

    public double? p1_swon { get; set; }

    public double? p0_svpt { get; set; }

    public double? p1_svpt { get; set; }

    public double? p0_rwon { get; set; }

    public double? p1_rwon { get; set; }

    public double? p0_rpt { get; set; }

    public double? p1_rpt { get; set; }

    public double? p0_52_swon { get; set; }

    public double? p1_52_swon { get; set; }

    public double? p0_52_svpt { get; set; }

    public double? p1_52_svpt { get; set; }

    public double? p0_52_rwon { get; set; }

    public double? p1_52_rwon { get; set; }

    public double? p0_52_rpt { get; set; }

    public double? p1_52_rpt { get; set; }

    public double? p0_sf_52_swon { get; set; }

    public double? p1_sf_52_swon { get; set; }

    public double? p0_sf_52_svpt { get; set; }

    public double? p1_sf_52_svpt { get; set; }

    public double? p0_sf_52_rwon { get; set; }

    public double? p1_sf_52_rwon { get; set; }

    public double? p0_sf_52_rpt { get; set; }

    public double? p1_sf_52_rpt { get; set; }
    ...
    public double? p0_commop_s_pct { get; set; }

    public double? p1_commop_s_pct { get; set; }

    public double? p0_commop_r_pct { get; set; }

    public double? p1_commop_r_pct { get; set; }
    ...
    public double? match_prob_commop { get; set; }
